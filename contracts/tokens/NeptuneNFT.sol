...
contract NeptuneNFT is ERC721, ReentrancyGuard, IWooStakingNFT, Ownable {
    ...
    uint256 public constant BOOSTING_AMOUNT = (13 * BASE_BOOSTING_MULTIPLIER) / 10; // 130%
    uint256 public constant BOOSTING_DURATION = 4838400; // 2 months
    ...
    constructor(address _stakingManager) ERC721("WooFi NeptuneNFT", "WN-NFT") {
